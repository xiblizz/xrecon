...
- Styling: Custom CSS (Shadcn-like)
...
## Features
- **Connection Manager**: Persists Host/Port/Password in Browser LocalStorage.
...
- **Map Manager**: Save your favorite Workshop map names for quick changing.
